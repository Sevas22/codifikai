...
const services = [
  {
    ...
    title: "Low Code",
    description:
      "Desarrollamos soluciones digitales ágiles para empresas que necesitan lanzar, validar y optimizar con velocidad, sin sacrificar calidad visual ni estructura profesional.",
  },
  {
    icon: Code2,
    title: "Desarrollo de Software",
    description:
      "Creamos plataformas, sistemas y productos a medida con arquitectura sólida, enfoque escalable y una implementación alineada con los procesos reales de tu negocio.",
  },
  {
    icon: Megaphone,
    title: "Marketing Digital (SEO)",
    description:
      "Diseñamos estrategias de posicionamiento y visibilidad digital para atraer tráfico de calidad, fortalecer tu presencia online y generar oportunidades comerciales sostenibles.",
  },
]
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-muted-foreground text-base md:text-lg leading-relaxed max-w-3xl mx-auto">
            Combinamos velocidad, estrategia y ejecución tecnológica para construir soluciones
            digitales que mejoran procesos, fortalecen marcas y generan crecimiento sostenible.
          </p>
        </div>
        ...
        >
          <p className="text-sm uppercase tracking-[0.18em] text-accent mb-3">Contáctanos</p>
          <h3
            className="text-2xl md:text-3xl font-bold text-foreground mb-6"
            style={{ fontFamily: 'var(--font-display)' }}
          >
            ¿Requieres alguno de estos servicios?
          </h3>
          <Button
            asChild
